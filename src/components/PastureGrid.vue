<template>
  <div class="pastureGrid" :style="gridStyleObject">
    <!-- Row -->
    <div v-for="(column, xIndex) in grid" :key="xIndex" class="pastureRow">
      <!-- Tile -->
      <div
        ...
        class="pastureTile"
        :class="{
          hasCow: cowPosition.x === xIndex && cowPosition.y === yIndex,
        }"
      >
        <!-- Cow Wrapper -->
        <transition name="fade">
          ...
          >
            ...
            >
              <img src="@/assets/cow_piece.png" class="cowFace" />
            </div>
          </div>
        </transition>
        ...
        <transition name="fade">
          <img
            v-if="
              isMealTime && cowPosition.x === xIndex && cowPosition.y === yIndex
            "
