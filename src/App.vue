    ...
    <div class="col1">
      ...
      <div class="setup-container">
        <div class="inputs-container">
          ...
          <!-- Start Button -->
          <button @click="runInstructions" :disabled="simulatorIsRunning">
            {{ simulatorIsRunning ? "Bessie's on the move!" : "Send Bessie!" }}
          </button>
        </div>
      </div>
      ...
      <transition name="fade">
        <div v-if="errorIsShowing" class="validationError">{{ errorText }}</div>
      </transition>
    </div>
    ...
    <div class="col2">
      <div class="farmer-container">
        <div class="bubble-container">
          <img src="@/assets/speechBubble.png" alt="" class="speechBubble" />
          <p class="speechText">
            {{ !isMealTime ? instructionToSpeech : "Chow time!" }}
          </p>
        </div>
        <img src="@/assets/farmer.png" alt="" class="farmer" />
      </div>
            ...
            switch (instruction) {
              ...
              case "f": {
                if (this.cowDirection === "n") {
                  ...
                  if (this.cowPosition.y + 1 < this.gridRows) {
                    this.cowPosition.y += 1;
                  }
                } else if (this.cowDirection === "e") {
                  if (this.cowPosition.x + 1 < this.gridColumns) {
